...
-DKEYCLOAK_REALM=${KEYCLOAK_REALM} -DKEYCLOAK_CLIENT_ID=${KEYCLOAK_CLIENT_ID} -DFILE_STORAGE_URL=${FILE_STORAGE_URL} -agentlib:jdwp=transport=dt_socket,address=0.0.0.0:8787,server=y,suspend=n"
